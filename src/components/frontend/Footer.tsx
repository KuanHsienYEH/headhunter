  ...
  return (
    <footer style={{ background: '#333F4F' }}>
      <div className="max-w-[1200px] mx-auto px-6 pt-12 pb-6">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-10 pb-10 border-b border-white/10">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-start gap-2 bg-white/8 border border-white/10 rounded-lg p-3 mb-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-[13px] text-white/55">
                <svg className="w-3.5 h-3.5 flex-shrink-0 text-[#FF6B00]" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
              ...
              <div className="flex items-start gap-2 text-[13px] text-white/55">
                <svg className="w-3.5 h-3.5 mt-0.5 flex-shrink-0 text-[#FF6B00]" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
