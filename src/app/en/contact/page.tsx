...
const contactInfo = [
  ...
  },
  {
    ...
    label: 'Address',
    value: "4F., No. 28, Sec. 2, Xinyi Rd., Da'an Dist., Taipei City 106001 (MRT Dongmen Station, Exit 3)",
  },
]
    ...
    <>
      ...
      <section className="relative overflow-hidden" style={{ minHeight: 300 }}>
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-20 md:py-28">
          ...
          <p className="text-white/70 text-[15px] max-w-lg">Whether you&apos;re hiring or looking for your next role, we&apos;d love to hear from you.</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-[1fr_280px] gap-14">
            ...
            <div className="flex flex-col gap-4">
              <div className="bg-[#F5F7FA] rounded-xl p-6">
                <h3 className="text-[14px] font-bold text-[#333F4F] mb-4">Contact Information</h3>
              ...
              <div className="bg-[#E8F0FB] rounded-xl p-5">
                <h3 className="text-[14px] font-bold text-[#333F4F] mb-2">Office Hours</h3>
                <p className="text-[13px] text-[#6B7A8D] leading-relaxed">Monday – Friday</p>
                <p className="text-[13px] font-medium text-[#0052A5]">09:00 – 18:00</p>
                <p className="text-[12px] text-[#6B7A8D] mt-2">Closed on weekends and public holidays</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="border-t border-[#E0E4EA]">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3614.982252826574!2d121.52274997557203!3d25.034676338263857!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3442a982c2b4f6a1%3A0xf85324de5e7f1a89!2z5beo5bCH5Lq65Yqb6LOH5rqQ6aGn5ZWP5pyJ6ZmQ5YWs5Y-4!5e0!3m2!1sen!2stw!4v1783385579170!5m2!1sen!2stw"
          width="100%"
          height="400"
