...
export const metadata: Metadata = {
  title: 'Insights',
  description: 'Talent market observations, hiring trends, and career advice.',
}
...
async function getPosts() {
  try {
    ...
    return rows.filter((p) => p.lang === 'en' || p.lang === 'both')
  } catch {
    return []
  }
}
    ...
    <>
      ...
      <section className="relative overflow-hidden" style={{ minHeight: 300 }}>
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-20 md:py-28">
          ...
          <p className="text-white/70 text-[15px] max-w-lg">Deep analysis on talent market trends, hiring strategy, and career development.</p>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          {list.length === 0 ? (
            <div className="bg-[#F5F7FA] rounded-xl p-12 text-center">
              ...
              <p className="text-[#6B7A8D] text-[14px]">No articles yet — check back soon.</p>
            </div>
          ) : (
            <>
              {featured && (
                <Link
                  href={`/en/insights/${featured.slug}`}
                ...
                >
                  <div className="relative overflow-hidden" style={{ minHeight: 280 }}>
                    ...
                    <span className="absolute top-4 left-4 text-[11px] px-3 py-1 rounded-full font-bold" style={{ background: '#FF6B00', color: 'white' }}>Featured</span>
                  </div>
              ...
              {rest.length > 0 && (
                <>
                  <div className="flex items-center gap-3 mb-6">
                    <span className="text-[12px] font-bold uppercase tracking-[.08em] text-[#6B7A8D]">All Articles</span>
      ...
      <section style={{ background: '#0052A5' }} className="py-14">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          ...
          <h2 className="text-2xl font-bold text-white mb-3">Stay ahead of the talent market</h2>
          <p className="text-white/65 text-[14px] max-w-md mx-auto mb-8">
            Contact us to receive regular insights on industry trends, compensation benchmarks, and hiring strategy.
          </p>
          <Link
            href="/en/contact"
