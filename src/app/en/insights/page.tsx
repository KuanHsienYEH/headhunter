    ...
    <>
      <section className="bg-navy py-16 md:py-20 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-medium text-warm-white mb-3">Insights</h1>
          <p className="text-warm-white/60 text-sm max-w-md">Talent market observations, hiring trends, and career advice.</p>
        </div>
      </section>
      ...
      <section className="py-16 max-w-6xl mx-auto px-6">
        {list.length > 0 ? (
            ...
            {list.map((post) => (
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <h2 className="font-display font-medium text-navy mb-2 leading-snug">{post.titleEn ?? post.titleZh}</h2>
                  {post.bodyEn && (
                    <p className="text-sm text-slate leading-relaxed line-clamp-3 mb-3">{post.bodyEn}</p>
                  )}
          ...
          <div className="bg-white border border-border-c rounded-xl p-8 text-center">
            <p className="text-slate text-sm">No articles yet — check back soon.</p>
          </div>
        )}
      </section>
    </>
