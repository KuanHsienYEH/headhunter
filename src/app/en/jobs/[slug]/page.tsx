  ...
  return (
    <>
      ...
      <div className="bg-white border-b border-[#E0E4EA] px-6 h-10 flex items-center gap-2 text-[13px] text-[#6B7A8D]">
        <Link href="/en" className="hover:text-[#0052A5]">Home</Link>
        <span>/</span>
        <Link href="/en/jobs" className="hover:text-[#0052A5]">Openings</Link>
        <span>/</span>
        <span className="text-[#333F4F] font-medium">{title}</span>
      </div>
      ...
      <section style={{ background: '#0052A5' }} className="px-6 py-10">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex gap-2 mb-4 flex-wrap">
            <span className="text-[11px] px-2.5 py-0.5 rounded-full font-medium" style={{ background: 'rgba(255,255,255,0.15)', color: 'rgba(255,255,255,0.85)' }}>{industry}</span>
        ...
        <div className="grid md:grid-cols-[1fr_300px] gap-10 items-start">
          ...
          <div>
            <div className="mb-8">
              ...
              <div className="text-[14px] text-[#6B7A8D] leading-[1.9] whitespace-pre-line">{desc}</div>
            </div>
          </div>

          <div className="flex flex-col gap-4">
            <div className="bg-white border border-[#E0E4EA] rounded-xl p-5">
              <div className="text-xs font-bold text-[#FF6B00] uppercase tracking-[.06em] mb-4">Summary</div>
              {[
            ...
            <div className="rounded-xl p-6" style={{ background: '#0052A5' }}>
              <div className="text-[16px] font-bold text-white mb-2">Interested in this role?</div>
              <p className="text-[13px] text-white/65 leading-relaxed mb-5">Submit your resume and we&apos;ll reach out within 2 business days.</p>
              <Link
            ...
            <div className="bg-white border border-[#E0E4EA] rounded-xl p-4 flex gap-3 items-center">
              ...
              <div>
                <div className="text-[14px] font-bold text-[#333F4F]">Consultant Name</div>
                <div className="text-[12px] text-[#6B7A8D] mt-0.5">Senior Search Consultant · Licensed Agency</div>
                <div className="text-[12px] mt-1.5 font-medium" style={{ color: '#0052A5' }}>Personally handled by the consultant</div>
              </div>
            </div>
            ...
            <div className="rounded-xl p-4 text-[12px] leading-relaxed" style={{ background: '#FFF0E6', color: '#8B4513' }}>
              ...
              Resumes are visible only to the consultant — never published or shared without your consent.
            </div>
          </div>
        </div>
      </div>
      ...
      {related.length > 0 && (
        <div className="max-w-[1200px] mx-auto px-6 pb-14 border-t border-[#E0E4EA] pt-10">
          <h2 className="text-[18px] font-bold text-[#333F4F] mb-5">Other openings</h2>
            ...
            {related.map((r) => (
              ...
              >
                <div className="flex gap-1.5 mb-3">
                  <span className="text-[11px] px-2.5 py-0.5 rounded-full font-medium" style={{ background: '#E8F0FB', color: '#0052A5' }}>{r.industryEn ?? r.industryZh}</span>
                  <span className="text-[11px] px-2.5 py-0.5 rounded-full font-medium" style={{ background: '#EAF7F0', color: '#27AE60' }}>✓ Active</span>
                </div>
                <div className="text-[14px] font-bold text-[#333F4F] mb-1">{r.titleEn ?? r.titleZh}</div>
